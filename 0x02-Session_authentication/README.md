# <p align='center'>0x02. Session authentication</p>
...
Solution: [api/v1/app.py](api/v1/app.py), [api/v1/views/users.py](api/v1/views/users.py)
...
Solution: [api/v1/auth/session_auth.py](api/v1/auth/session_auth.py),[api/v1/app.py](api/v1/app.py)
...
Solution: [api/v1/auth/session_auth.py](api/v1/auth/session_auth.py)
...
Solution: [api/v1/auth/auth.py](api/v1/auth/auth.py)
...
Solution: [api/v1/app.py](api/v1/app.py)
...
Solution: [api/v1/views/session_auth.py](api/v1/views/session_auth.py), [api/v1/views/__init__.py](api/v1/views/__init__.py)
...
Solution: [api/v1/auth/session_auth.py](api/v1/auth/session_auth.py), [api/v1/views/session_auth.py](api/v1/views/session_auth.py)
...
- Overload `def create_session(self, user_id=None):`
    ...
    - Return No`ne if `super()` can’t create a Session ID
...
Solution: [api/v1/auth/session_exp_auth.py](api/v1/auth/session_exp_auth.py), [api/v1/app.py](api/v1/app.py)
...
Solution: [api/v1/auth/session_db_auth.py](api/v1/auth/session_db_auth.py), [api/v1/app.py](api/v1/app.py), [models/user_session.py](models/user_session.py)
# <p align='center'>0x01. Basic authentication</p>
...
- [Mandatory Tasks](#mandatory)
  ...
  - [11. Basic - Overload current_user - and BOOM!](#11-basic---overload-current_user---and-boom)
- [Advnaced Tasks](#advanced)
  - [12. Basic - Allow password with ":"](#12-basic---allow-password-with-)
  - [13. Require auth with stars](#13-require-auth-with-stars)
...
![Authentication](../Imgs/0x01.Basic_authentication.png)
...
For testing this new error handler, add a new endpoint in a`pi/v1/views/index.py`:
...
Solution: [api/v1/app.py](api/v1/app.py), [api/v1/auth/basic_auth.py](api/v1/auth/basic_auth.py)
...
Solution: [api/v1/auth/basic_auth.py](api/v1/auth/basic_auth.py)
